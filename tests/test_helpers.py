...
@mock.patch("pyt.helpers.logging")
...
def test_create_mock_html_json(mock_url_open, mock_open):
    ...
    gzip_html_filepath = os.path.join(pyt_mocks_path, gzip_html_filename)
